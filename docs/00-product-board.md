...
| T-020 | Redirections vers l'authentification : tout ne pointe PAS vers la page de connexion unique. Constate par MiKL sur les boutons des emails (« Voir le message ») qui ramenent sur l'ancienne page de login. Audit complet a faire : emails, edge functions, middlewares, actions, liens en dur | Bug | MiKL 2026-09-09 (2 captures) | Must | Interne | H | M | En cours | — | 2026-09-09 | — | 2026-09-09 |
