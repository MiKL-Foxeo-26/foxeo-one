...
|-----------|-------------|----------|----------|
| **FOXEO-HUB** | MiKL | Cockpit central, gestion clients, Validation Hub | **Élio Hub** |
...
**Profil MiKL** : Développeur full-stack et product builder — code réellement les produits (Next.js, React, Supabase), augmenté par l'IA (Cursor/BMAD). Compétence clé : **automatisation de process métier** — identifier les tâches répétitives du client et les transformer en modules sur mesure.
